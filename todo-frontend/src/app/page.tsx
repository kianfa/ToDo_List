  ...
  return (
    <main className="w-full max-w-2xl">
      ...
      <div className="flex gap-3 mb-8">
        ...
        />
        <button className="px-6 py-3 rounded-lg bg-accent text-white font-semibold hover:bg-accent-hover transition-colors">
          Add Task
        </button>
      </div>
      ...
      <div className="space-y-3">
        {/* Example Task Item */}
        <div className="flex items-center justify-between p-4 rounded-lg bg-surface border-l-4 border-accent shadow-sm">
          <span className="text-textPrimary">Learn Next.js and FastAPI</span>
